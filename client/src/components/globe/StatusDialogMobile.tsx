...
import { Compass, Heart, Check } from "lucide-react";
...
export default function StatusDialogMobile({ dialogOpen, setDialogOpen, selectedCountry, setCountriesState }: StatusDialogProps) {
    return (
        <Drawer open={dialogOpen} onOpenChange={setDialogOpen}>
            <DrawerContent className="p-4 pt-0 z-50">
                ...
                <div className="flex flex-col gap-4 mt-4">
                    ...
                    {/* VISITED */}
                    <div className="w-full flex items-center justify-between p-5 rounded-2xl border border-zinc-200 active:scale-[0.98] transition-all bg-linear-to-r from-amber-50 to-transparent">
